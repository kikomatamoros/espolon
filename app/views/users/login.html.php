      ...
      <div class="row probootstrap-gutter40">
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                <h4>
                    <a href="<?=ROOT_URL?>/users/register">¿No estas registrado? Registrate ahora</a>
                </h4>
            </div>
            <div class="form-group">
              <?=$form->input("submit",["name" => "submit", "class" => "btn btn-primary btn-lg", "id"=>"submit", "value"=>"Inicia Sesion"]);?>
            </div>
          </form>
        </div>
      </div>
